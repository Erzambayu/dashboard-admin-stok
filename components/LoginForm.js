      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="text-center text-sm text-gray-600">
            <p>Demo: username = <code className="bg-gray-100 px-1 py-0.5 rounded">admin</code>, password = <code className="bg-gray-100 px-1 py-0.5 rounded">admin123</code></p>
          </div>
        </form>
      </div>
    </div>
